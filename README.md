...
After installing the CLI, you need to configure access to your AWS Cloud. You can easily run `aws configure` then provide the required informations. You may need to generate auth token and secret from your IAM section. 
